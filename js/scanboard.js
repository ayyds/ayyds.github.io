$(function(){
    ...
    var myMap = new AMap.Map('myMap',{
        ...
        center: [116.414249,39.919114],
    });
    
    var point = [
    	[116.40337,39.924111],
    	[104.056753,30.650956],
    	[103.73788,36.061257],
    	[116.689557,39.861244],
    	[116.024067,40.362639],
    	[116.27648,39.998183],
    	[116.392518,39.943578],
    	[118.797369,32.030585],
    	[100.203001,27.108909],
    	[100.244964,26.877524]
	]
	var name=['故宫博物院','武侯祠','灵隐寺','北京环球度假区','八达岭长城','颐和园','恭王府','夫子庙','玉龙雪山','丽江古城']
	var ps=['5A','4A','无','无','5A','5A','5A','无','5A','5A']
	var pin=['4.8','4.5','4.7','4.5','4.7','4.7','4.7','4.5','4.5','4.6']
	var der=['北京市东城区景山前街4号','成都市武侯区武侯祠大街231号','杭州市西湖区灵隐路法云弄1号','北京市通州区北京环球度假区','北京市延庆区G6京藏高速58号出口','北京市海淀区新建宫门路19号','北京市西城区前海西街17号','南京市秦淮区秦淮河风景区','丽江市玉龙县丽江古城以北15公里处','丽江市古城区大研古城']
	var num=['4009501925','028-81290168','0571-87968665','4000 688 688','010-61118002','010 62881144','010-83288149','025-52855667','0888-5137677','0888-5111118']
    var maker;
